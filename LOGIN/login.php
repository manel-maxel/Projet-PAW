    ...
    <div class="form-box <?= isActiveForm('login',$activeForm);?>" id="login-form">
      <form action="login_register.php" method="post">
        ...
        <div class="inputgroup">
          ...
          <input type="email" id="email" placeholder="Enter your email" name="login_email" required>
          <div class="error-message" id="emailError"></div>
        </div>
        
        <div class="inputgroup">
          <label for="password">Password</label>
          <input type="password" id="password" placeholder="Enter your password" name="login_password" required>
          <div class="error-message" id="passwordError"></div>
        </div>
        
        <input type="hidden" name="login" value="1">
        
        <button type="submit" class="btnlgn" id="btnLgn">Login</button>
