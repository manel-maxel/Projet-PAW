$(document).ready(function(){
    ...
    $(document).on("input change", "#name, #email, #registerPassword, #role", function(){
    ...
    function validateRegisterForm() {
        ...
        const isValid = isNameValid && isEmailValid && isPasswordValid && isRoleValid;
        
        updateRegisterButton(isValid);
        
        updateRegisterErrorMessages(name, email, password, role, emailRegex);
    }
    ...
    function updateRegisterErrorMessages(name, email, password, role, emailRegex) {
        ...
        if (email === "") {
            ...
            $("#registerEmailError").text("Invalid email format");
        } else {
            $("#registerEmailError").text("");
        }
        ...
        if (password === "") {
            ...
            $("#registerPasswordError").text("Password must be at least 6 characters");
        } else {
            $("#registerPasswordError").text("");
        }
    ...
    function handleLogin() {
        ...
        setTimeout(function(){
            ...
            setTimeout(function(){
                window.location.href = 'attendenci.html';
            }, 1000);
        }, 1500);
    }
    ...
    $(document).on('keypress', function(e){
        if(e.which === 13) {
            e.preventDefault();
            if($('#login-form').hasClass('active') && !$("#btnLgn").hasClass('inactive')) {
                $("#btnLgn").click();
            } else if($('#register-form').hasClass('active') && !$("#btnRegister").hasClass('inactive')) {
                $("#btnRegister").click();
            }
        }
    });
